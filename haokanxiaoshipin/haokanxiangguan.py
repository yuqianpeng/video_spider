...
if __name__ == '__main__':
	...
	# list1 = ['https://haokan.baidu.com/videoui/page/videoland?pd=haokan_share&context=%7B%22cuid%22%3A%220av6tjPW2i03iSuOga24i_uWSalli-fq_aH-ijanHaKWLMkRB%22%2C%22nid%22%3A%2212922407705409416517%22%7D']
		...
		try:
			if count < 10:
				try:
					...
					p = Pool(4)
					for i in range(4):
					    p.apply_async(main('https://haokan.baidu.com/videoui/page/videoland?pd=haokan_share&context=%7B%22cuid%22%3A%220av6tjPW2i03iSuOga24i_uWSalli-fq_aH-ijanHaKWLMkRB%22%2C%22nid%22%3A%2215505170361778528183%22%7D'))
					    p.close()
					    p.join() 
				except Exception as e:
					print(e)
